...
while true; do
    ...
    hadoop jar /opt/hadoop/share/hadoop/tools/lib/hadoop-streaming-2.5.1.jar ­D mapreduce.job.reduces=2 -mapper mapper -reducer reducer -file mapper -file reducer -input $INPUT -output $OUTPUT
